...
pub static mut CONCURRENTHASHMAPSPINLOCK: ConcurrentHashMapSpinLock =
    ConcurrentHashMapSpinLock::new();

// Concurrent hash map implementation.
pub struct ConcurrentHashMapSpinLock {
...
impl ConcurrentHashMapSpinLock
where
